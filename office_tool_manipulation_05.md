...
<p align="center"><img alt="カラースケール" src="images/excel_conditional_formatting_1e.png" /></p>
...
>**【グラデーションを使ってはいけない】**<br>
>棒グラフに限らず、グラフにグラデーションをかけるのは悪い手法です。グラデーションがあると、グラフを正しく読み取りにくくなるからです。グラフは単色で描くようにしましょう。
